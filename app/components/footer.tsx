...
export default function Footer() {
    ...
    <footer className="mt-20 md:mt-28 border-t border-[var(--color-ring)]/70 bg-[var(--color-surface)]/70 backdrop-blur">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          <div className="md:col-span-5">
            ...
            <div className="space-y-2">
                <Link href="#home" className="link-underline link-gradient">{t.nav.home}</Link>
                <div><Link href="#services" className="link-underline link-gradient">{t.nav.services}</Link></div>
                <div><Link href="#cases" className="link-underline link-gradient">{t.nav.cases}</Link></div>
            </div>
            <div className="space-y-2">
                <div><Link href="#about" className="link-underline link-gradient">{t.nav.about}</Link></div>
                <div><Link href="#contact" className="link-underline link-gradient">{t.nav.contact}</Link></div>
                <div><a href="/site.webmanifest" className="link-underline link-gradient">PWA</a></div>
            </div>
            </nav>
            ...
            <div className="rounded-2xl p-4 ring-1 ring-[var(--color-ring)] bg-[var(--color-surface-2)]">
                ...
                <form onSubmit={(e) => { e.preventDefault(); alert(t.newsletter.ok); }}>
        ...
        <div className="mt-8 flex flex-wrap items-center justify-between gap-3 text-xs text-[var(--color-muted)]">
            ...
            <div className="flex items-center gap-3">
            <a className="link-underline" href="/privacy">Privacy</a>
            <a className="link-underline" href="/terms">Terms</a>
            <a className="link-underline" href="/cookies">Cookies</a>
            </div>
        </div>
        </div>
    </footer>
